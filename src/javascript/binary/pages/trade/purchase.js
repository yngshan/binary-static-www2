...
var Purchase = (function () {
    ...
    var display = function (details) {
        ...
        if (error) {
            ...
            confirmation_error.innerHTML = (/not authorised/.test(error.message) ? error['message'] + '<a href="' + page.url.url_for('cashier/authenticate') + '"> ' + text.localize('Authorise your account.' + '</a>') : error['message']);
        } else {
