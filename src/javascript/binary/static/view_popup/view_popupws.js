var ViewPopupWS = (function() {
    ...
    var normalUpdate = function() {
        ...
        containerSetText('trade_details_current_date'    , epochToDateTime(!is_ended ? contract.current_spot_time : (user_sold ? contract.sell_spot_time || contract.sell_time : contract.date_expiry)));
